...
public class Query {
    ...
    public static void main(String[] args) {
        ...
        mfs.put("sum_3_quant", new ArrayList<Integer>());
        ...
        try {
            ...
            while (rs.next()) {
                ...
                for(int i = 0; i < mfs.get("cust").size(); i++) {
                    if(cust.equals((String)mfs.get("cust").get(i)+"")) {
                        _flag = false;
                        break;
                    }
                }
            ...
            while (rs.next()) {
                ...
                for(int i = 0; i < mfs.get("cust").size(); i++) {
                    // Sigma(1)
                    if((!(mfs.get("cust").get(i)+"").equals("null"))&&(cust.equals((String)mfs.get("cust").get(i)+""))&&(state.equals("NY"+""))) {
                        // sum_1_quant
            ...
            while (rs.next()) {
                ...
                for(int i = 0; i < mfs.get("cust").size(); i++) {
                    // Sigma(2)
                    if((!(mfs.get("cust").get(i)+"").equals("null"))&&(cust.equals((String)mfs.get("cust").get(i)+""))&&(state.equals("CT"+""))) {
                        // sum_2_quant
            ...
            while (rs.next()) {
                ...
                for(int i = 0; i < mfs.get("cust").size(); i++) {
                    // Sigma(3)
                    if((!(mfs.get("cust").get(i)+"").equals("null"))&&(cust.equals((String)mfs.get("cust").get(i)+""))&&(state.equals("NJ"+""))) {
                        // sum_3_quant
                        String _sum_3_quant = mfs.get("sum_3_quant").get(i)+"";
                        if(_sum_3_quant.equals("null")) {
                            _sum_3_quant = "0";
                        }
                        mfs.get("sum_3_quant").set(i, (int)(Double.parseDouble(_sum_3_quant)+Double.parseDouble(quant)));
                        // count_3_quant
            ...
            // print output
            int rowNum = 0;
            System.out.println("cust                 avg_1_quant     avg_2_quant     avg_3_quant");
            System.out.println("================================================================");
            for(int i = 0; i < mfs.get("cust").size(); i++) {
                // having clause
                if((!(mfs.get("sum_2_quant").get(i)+"").equals("null"))&&(!(mfs.get("count_2_quant").get(i)+"").equals("null"))&&(!(mfs.get("sum_1_quant").get(i)+"").equals("null"))&&(!(mfs.get("count_1_quant").get(i)+"").equals("null"))&&(!(mfs.get("sum_3_quant").get(i)+"").equals("null"))&&(!(mfs.get("count_3_quant").get(i)+"").equals("null"))&&(Double.parseDouble((Double.parseDouble((int)mfs.get("sum_1_quant").get(i)+"")/Double.parseDouble((int)mfs.get("count_1_quant").get(i)+""))+"")>Double.parseDouble((Double.parseDouble((int)mfs.get("sum_2_quant").get(i)+"")/Double.parseDouble((int)mfs.get("count_2_quant").get(i)+""))+""))&&(Double.parseDouble((Double.parseDouble((int)mfs.get("sum_1_quant").get(i)+"")/Double.parseDouble((int)mfs.get("count_1_quant").get(i)+""))+"")>Double.parseDouble((Double.parseDouble((int)mfs.get("sum_3_quant").get(i)+"")/Double.parseDouble((int)mfs.get("count_3_quant").get(i)+""))+""))) {
                    rowNum++;
                    // cust
                    ...
                    // avg_3_quant
                    if(((mfs.get("sum_3_quant").get(i)+"").equals("null"))||((mfs.get("count_3_quant").get(i)+"").equals("null"))) {
                        System.out.print(String.format("%16s", "null"));
                    }
                    else {
                        System.out.print(String.format("%16.3f", Double.parseDouble((int)mfs.get("sum_3_quant").get(i)+"")/Double.parseDouble((int)mfs.get("count_3_quant").get(i)+"")));
                    }
                    System.out.println("");
                }
            }
